...
export default function CalendarPage() {
  ...
  const dayRouteStops = dayAppointments.filter(item => item.status === 'scheduled' && item.customer_addresses).map(item => ({
    id: item.id,
