...
function AppointmentCard({ appointment, attachmentUrls, onEdit, onCancel, onStatus, onAddNote }: { appointment: Appointment; attachmentUrls: Record<string, string>; onEdit: (appointment: Appointment) => void; onCancel: (appointment: Appointment) => void; onStatus: (appointment: Appointment) => void; onAddNote: (appointment: Appointment) => void }) {
